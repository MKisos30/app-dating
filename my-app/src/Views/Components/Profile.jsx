...
const [editInput, setEditInput] = useState(false)
  ...
  return (
    <Suspense fallback={<h2>Loading...</h2>}>
        <Await resolve={user}>
            <Form action="/main-page/profile" method="post" className="formPfofile" >
                ...
                <div >
                    ...
                    return (
                        ...
                        />
                        {hobbies.length !== 1 && (
                            <button className="hobbieButton" type="button" onClick={removeInput}>
                            X
                            </button>
                        )}
                        </div>
...
const updateUserSend = async ({ fullName, gender, city, lookingFor, dateOfBirth, about, profilePicture, hobbies }) => {
    const { data } = await axios.post('/user/updateUser', { fullName, gender, city, lookingFor, dateOfBirth, about, profilePicture, hobbies })
    return data;
}
